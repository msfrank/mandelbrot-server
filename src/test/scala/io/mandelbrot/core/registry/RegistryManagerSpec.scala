...
class RegistryManagerSpec(_system: ActorSystem) extends TestKit(_system) with ImplicitSender with WordSpecLike with ShouldMatchers with BeforeAndAfterAll {
  ...
  val registration1 = AgentSpec(agent1, "mandelbrot", Map.empty, checks1, metrics1)
  ...
  val registration2 = AgentSpec(agent2, "mandelbrot", Map.empty, checks2, metrics2)
  ...
  val registration3 = AgentSpec(agent3, "mandelbrot", Map.empty, checks3, metrics3)
  ...
  val registration4 = AgentSpec(agent4, "mandelbrot", Map.empty, checks4, metrics4)
  ...
  val registration5 = AgentSpec(agent5, "mandelbrot", Map.empty, checks5, metrics5)

  val joinedOn = new DateTime(0, DateTimeZone.UTC)
  val registrationHistory1 = AgentSpec(agent1, "mandelbrot", Map("history" -> "1"), checks1, metrics1)
  val metadataHistory1 = AgentMetadata(agent1, 1, joinedOn, joinedOn, None)
  val registrationHistory2 = AgentSpec(agent1, "mandelbrot", Map("history" -> "2"), checks1, metrics1)
  val metadataHistory2 = AgentMetadata(agent1, 1, joinedOn, joinedOn.plusMinutes(1), None)
  val registrationHistory3 = AgentSpec(agent1, "mandelbrot", Map("history" -> "3"), checks1, metrics1)
  val metadataHistory3 = AgentMetadata(agent1, 1, joinedOn, joinedOn.plusMinutes(1), None)
  val registrationHistory4 = AgentSpec(agent1, "mandelbrot", Map("history" -> "4"), checks1, metrics1)
  val metadataHistory4 = AgentMetadata(agent1, 1, joinedOn, joinedOn.plusMinutes(1), None)
  val registrationHistory5 = AgentSpec(agent1, "mandelbrot", Map("history" -> "5"), checks1, metrics1)
